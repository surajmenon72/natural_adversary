...
if(params['dataset'] == 'MNIST'):
    from models.mnist_model_wtsmooth2 import Generator, Noise_Generator, Discriminator, Discriminator_Identity, DHead, DHead_KL, DHead_Identity, DHead_Identity_IDX, QHead, Encoder, ResnetEncoder, CHead, Stretcher, HHead
...
extra_transforms =  transforms.Compose([
                        ...
                        transforms.RandomApply(
                            [
                                transforms.ColorJitter(
                                    brightness=0.0, contrast=0.0, saturation=0.2, hue=0.0
                                )
                            ],
                            p=0.9,
                        ),
...
print(netQ)
clip_module_weights(netQ, min_v=-1, max_v=1)
